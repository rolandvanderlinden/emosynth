...
public class PrototypeApplication
{
	...
	{
		PrototypeApplet Papplet = new PrototypeApplet();
	 ...
	 * @return
	 */
	protected static JFrame buildFrameAroundApplet(PrototypeApplet applet)
	{
		if(applet == null)
			throw new UnsupportedOperationException();		
		
		//We will put the applet in a window (jframe).
		AppletFrame frame = new AppletFrame(PrototypeConfig.appname, applet);
		frame.add(applet);
