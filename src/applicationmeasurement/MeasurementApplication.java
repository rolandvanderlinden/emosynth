...
public class MeasurementApplication
{
	...
	{
		MeasurementApplet Papplet = new MeasurementApplet();
		buildFrameAroundApplet(Papplet);
	}
	 ...
	 * @return
	 */
	protected static JFrame buildFrameAroundApplet(MeasurementApplet applet)
	{
		if(applet == null)
			throw new UnsupportedOperationException();		
		
		//We will put the applet in a window (jframe).
		AppletFrame frame = new AppletFrame(MeasurementConfig.appname, applet);
		frame.add(applet);
