...
{
	private ButtonTextController controller;
	...
	{
		this.controller = new ButtonTextController(this);
		...
		//Locations
		VectorF2 afbuttonlocation = LocationCalculator.calculateLocation(afbuttonsize, holdersize, LocationType.CENTER, 0.5f);
